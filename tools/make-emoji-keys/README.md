...
This module takes care of generating emoji data bundled with UP Keyboard.
...
A gradle task called 'makeEmoji' builds and runs this tool to generate android resource file which. Path to UP Keyboard's res directory is automatically set so the file is ready to be bundled at build.
