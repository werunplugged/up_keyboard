...
/**
 * Buffer for storing and processing audio recording data.
 * Provides conversion from byte array to float samples for recognition.
 */
public class RecordBuffer {
    ...
    /**
     * Convert the recorded byte buffer to float samples for recognition
     * @return Float array of normalized audio samples
     */
